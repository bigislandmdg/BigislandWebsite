          ...
          >
            {sections.map((section, idx) => (
              ...
              >
                ...
                >
                  <h5 className="text-lg font-bold text-teal-400">{section.title}</h5>
