...
export default function FournisseurScreen() {
  ...
  return (
    <>
      ...
      <section ref={ref} id="fournisseur-solutions" className="pt-32 pb-16 px-6 max-w-6xl mx-auto text-center">
        <div ref={refTitle}>
          <motion.h1
            ...
            animate={titleInView ? "visible" : "hidden"}
          >
            <SplitText text={t('fournisseurPage.title')} className="text-4xl font-bold" />
          </motion.h1>
        </div>
