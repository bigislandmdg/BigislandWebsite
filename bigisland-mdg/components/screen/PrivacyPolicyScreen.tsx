...
type PolicySection = {
  title: string;
  content: string;
  image?: string; // optionnel si tu veux mettre une image
};
        ...
        >
          <div className="text-center md:text-left flex-1">
            <h3 className="text-2xl font-bold text-zinc-900 mb-2">
              {t('privacyPolicy.needHelp') || 'Besoin d’aide concernant les mentions légales ?'}
            </h3>
            <p className="text-zinc-700">
              {t('privacyPolicy.contactUs') || 'Contactez-nous à legal@exemple.com'}
            </p>
          </div>
