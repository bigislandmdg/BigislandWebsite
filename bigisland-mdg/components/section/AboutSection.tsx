...
import { Laptop, Car, Headset, PackagePlus } from 'lucide-react';
...
export default function AboutSection() {
  ...
  // assign icons
  expertises[0].icon = <Car className="h-8 w-12 text-blue-600" />;
  expertises[1].icon = <Headset className="h-8 w-12 text-blue-600" />;
  expertises[2].icon = <Laptop className="h-8 w-12 text-blue-600" />;
  expertises[3].icon = <PackagePlus className="h-8 w-12 text-blue-600" />;
        ...
        >
          {expertises.map((exp, idx) => (
            <motion.div
              ...
              className="rounded-3xl bg-blue-50 p-6 shadow-sm border border-gray-100"
            >
